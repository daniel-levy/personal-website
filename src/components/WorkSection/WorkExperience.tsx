...
const WorkExperience = (props: WorkExperienceProps) => {
  const { logo, company, date, title, experience, skills } = props;
  return (
    <div className="w-full flex flex-row space-x-10">
      <div className="h-32 w-32 bg-sky-900 rounded-full relative z-0 flex justify-center items-center hover:animate-wiggle">
      ...
      <div className="flex-1 text-neutral-700">
        <div className="w-full flex flex-col">
          ...
          <text className="mt-6">{experience}</text>
